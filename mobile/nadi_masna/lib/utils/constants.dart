class K {
  ...
  //Android Emulator
  // static const String serverIp   = '10.0.2.2';   // Phone emulator localhost
 ...
 static const String baseUrl    = 'http://$serverIp:$serverPort';
  ...
  static const String serverIp   = '192.168.1.8';   //  Local network IP (update with `ipconfig` output)
// static const String serverIp = 'localhost'; // Localhost (use with real device and port forwarding)
